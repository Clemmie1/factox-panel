                ...
                <div id="kt_toolbar_container" class=" container-xxl  d-flex flex-stack flex-wrap">
                    ...
                    <div class="page-title d-flex flex-column me-3">
                        <h1 class="d-flex text-dark fw-bold my-1 fs-3">
                            Инфопанель доставляемости электронной почты и управления репутацией
                        </h1>
                        <div class="text-gray-600 fs-7">
                            Инфопанель доставляемости электронной почты и управления репутацией обеспечивает видимость факторов, влияющих на доставляемость электронной почты.
                        </div>
                    </div>
                </div>
            </div>
