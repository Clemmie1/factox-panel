                ...
                <div id="kt_toolbar_container" class=" container-xxl  d-flex flex-stack flex-wrap">
                    ...
                    <div class="page-title d-flex flex-column me-3">
                        ...
                        <div class="text-gray-600 fs-7">
                            Список запретов - это перечень адресов, на которые не должны отправляться электронные письма. Запрещенные адреса возникают на основе возвратов, жалоб или добавлений вручную пользователем.
                        </div>
                    </div>
                </div>
            </div>
