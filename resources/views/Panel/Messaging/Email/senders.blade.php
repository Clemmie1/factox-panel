                ...
                <div id="kt_toolbar_container" class=" container-xxl  d-flex flex-stack flex-wrap">
                    ...
                    <div class="page-title d-flex flex-column me-3">
                        <h1 class="d-flex text-dark fw-bold my-1 fs-3">
                            Утвержденные отправители
                        </h1>
                        <div class="text-gray-600 fs-7">
                            Утвержденный отправитель - это адрес, используемый в заголовке "От:" отправляемого электронного письма, например help@example.com. Каждый адрес отправителя электронной почты должен быть зарегистрирован, чтобы можно было использовать его для доставки электронной почты.
                        </div>
                    </div>
                </div>
            </div>
