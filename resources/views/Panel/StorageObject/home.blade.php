...
<head>
    ...
    <title>Хранилище объектов</title>
            ...
            <div class="toolbar d-flex flex-stack py-3 py-lg-5" id="kt_toolbar">
                <div id="kt_toolbar_container" class=" container-xxl  d-flex flex-stack flex-wrap">
                    ...
                    <div class="d-flex align-items-center py-2">
                        <button class="btn btn-sm btn-secondary" data-kt-drawer-show="true" data-kt-drawer-target="#kt_drawer_example_basic">
                            Создать
                        </button>
                    </div>
                </div>
...
{{--                    <div class="justify-content-center text-center m-xxl-10">
                ...
                @livewire('panel.storage-object.load-bucket')
