<div>
    <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
        <div class="mb-3 mb-md-0 fw-semibold">
            ...
            <div class="fs-6 text-gray-700 pe-7">Двухфакторная аутентификация добавляет дополнительный уровень безопасности вашей учетной записи.
                Для входа дополнительно потребуется ввести 6-значный код.</div>
        </div>
