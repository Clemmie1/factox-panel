<div>
    <div class="modal-header" >
        <h3 class="modal-title">Продлить хранилище объектов</h3>
    ...
    <div class="modal-footer">
        ...
        <button type="button" wire:click="renewBucket" class="btn btn-primary" wire:target="renewBucket" wire:loading.remove style="height: 53px">Продлить</button>
        <button type="button" wire:click="renewBucket" class="btn btn-secondary" disabled wire:target="renewBucket" wire:loading style="height: 53px">
