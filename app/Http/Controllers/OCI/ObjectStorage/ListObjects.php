...
{
    static public function getList($bucketID)
    {
        $signer = new Signer(
        ...
        $curl = curl_init();
        $url = 'https://objectstorage.eu-frankfurt-1.oraclecloud.com/n/frezk3uujhtw/b/'.$bucketID.'/o?fields=name,size,timeCreated,timeModified,storageTier,archivalState';
        $method = 'GET';
        $body = '{"objects": "'.$bucketID.'"}';
